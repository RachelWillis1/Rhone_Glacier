...
# folderlist
#
with open('./output/folderlist.csv', newline='') as csvfile:
...
##txt
with open("./output/folderlist.txt", "w") as outfile:
    outfile.write("\n".join(folderlist))

os.remove('./output/folderlist.csv')

#
# filelist
#
with open('./output/filelist.csv', newline='') as csvfile:
    reader = csv.reader(csvfile, delimiter=',', quotechar='|')
...
#txt
with open("./output/filelist.txt", "w", encoding="utf-8") as outfile:
    outfile.write("\n".join(filelist))

os.remove('./output/filelist.csv')